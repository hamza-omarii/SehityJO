<nav class="navbar navbar-expand-lg p-3 border-bottom justify-content-between custom-height">
    ...
    <div class="d-flex justify-content-end position-relative">
        <div class="btn-group mx-3 ">
            ...
            @if (Auth::guard('doctor')->user()->unreadNotifications->count() > 0)
                <ul class="dropdown-menu dropdown-menu-end p-0" style="width: 400px ; border:none">
                    @foreach (Auth::guard('doctor')->user()->unreadNotifications as $notify)
        ...
        <div class="btn-group ms-auto ">
            ...
            <ul class="dropdown-menu dropdown-menu-end">
                ...
                <li><a href="{{ route('doctor.edit.profile', Auth::guard('doctor')->user()->id) }}" class="dropdown-item p-3 fw-bold"><i class="fa-solid fa-id-card me-2"></i>{{ __('main.profile') }}</a></li>
                <li>
                    <form action="{{ route('doctor.logout') }}" method="POST" class="dropdown-item p-1">
                        @csrf
