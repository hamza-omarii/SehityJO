<nav class="navbar navbar-expand-lg p-3 border-bottom justify-content-between custom-height">
    ...
    <div class="d-flex justify-content-end position-relative">
        ...
        <div class="btn-group mx-3 ">
            ...
            <button type="button" class="btn rounded-circle  btn-outline bg-light" data-bs-toggle="dropdown" aria-expanded="false">
        ...
        <div class="btn-group ms-auto ">
            <button type="button" class="rounded-circle  btn btn-outline bg-light " data-bs-toggle="dropdown" aria-expanded="false">
                <i class="icon-user fa-solid fa-user fa-2x text-dark"></i>
            </button>

            <ul class="dropdown-menu dropdown-menu-end">

                <li><a href="{{ route('admin.edit.profile', Auth::guard()->user()->id) }}" class="dropdown-item p-3 fw-bold"><i class="fa-solid fa-id-card me-2"></i>{{ __('dashboard.profile') }}</a></li>
                <li>
