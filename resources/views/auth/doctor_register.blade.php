    ...
    <div class="row justify-content-center" style="width: 100%">
        <div class="col-md-12 p-5">
            <div class="card wow bounceIn border-0">
                <h2 class="card-header text-center title-register">{{ __('who_are_you.doctor_registration') }}</h2>

                <div class="card-body">
                    <form method="POST" action="{{ route('doctor.create') }}" aria-label="{{ __('who_are_you.register') }}" enctype="multipart/form-data">
                        @csrf
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-12 col-md-3">
                                    <div class="form-floating">
                                        ...
                                        <label for="password_confirmation">{{ __('who_are_you.password-confirm') }}</label>
                                    </div>
                                ...
                                <div class="col-12 col-md-6">
                                    ...
                                    <div class="form-group row mx-auto">
                                        <select name="hospital_id" class="form-select form-select-lg @error('hospital_id') is-invalid @enderror" aria-label="Default select example" style="width: 98%">
                                            <option disabled selected>{{ __('who_are_you.open_menu') }}</option>
                                ...
                                <div class="col-12">
                                    <div>
                                        <label for="formFileLg" class="label col-form-label fs-6">{{ __('who_are_you.profile_pic') }} :</label>
                        ...
                        <div class="clinic_information mb-2">
                            ...
                            <div class="row mb-2">
                                <div class="col-md-6 col-lg">
                                    <input type="number" name="clinic_number" value="{{ old('clinic_number') }}" class="form-control mb-lg-auto mb-sm-2 @error('clinic_number') is-invalid @enderror" placeholder="{{ __('who_are_you.clinic_number') }}">
                                    @error('clinic_number')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
                                ...
                                <div class="col-md-6 col-lg mb-md-2 mb-sm-2">
                                    <input type="number" name="floor" value="{{ old('floor') }}" class="form-control mb-lg-auto mb-sm-2 @error('floor') is-invalid @enderror" placeholder="{{ __('who_are_you.floor_number') }}">
                                    @error('floor')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
                                ...
                                <div class="col-md-6 col-lg mb-md-2 mb-sm-2">
                                    <input type="number" name="phone_number" value="{{ old('phone_number') }}" class="form-control mb-lg-auto mb-sm-2 @error('phone_number') is-invalid @enderror" placeholder="{{ __('who_are_you.phone_number') }}">
                                    @error('phone_number')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
                                ...
                                <div class="col-md-6 col-lg mb-md-2 mb-sm-2 fees">
                                    <input type="text" name="fees" value="{{ old('fees') }}" class="form-control mb-lg-auto mb-sm-2 @error('fees') is-invalid @enderror" placeholder="{{ __('who_are_you.fees') }}">
                                ...
                                <div class="col-md-6 col-lg mb-md-2 mb-sm-2">
                                    <input type="text" name="waiting_time" value="{{ old('waiting_time') }}" class="form-control mb-lg-auto mb-sm-2 @error('waiting_time') is-invalid @enderror" placeholder="{{ __('who_are_you.waiting_time') }}">
                                    @error('waiting_time')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
                        ...
                        <div class="form-group">
                            <button type="submit" class="my-2 rounded btn btn-lg submit px-3 w-100">{{ __('who_are_you.register') }}</button>
                        </div>
                    </form>
                </div>
            </div>
